...
export const SyncWriteStream: any;
...
export function fstat(fd: any, options: any, callback: any, ...args: any[]): void;
...
export function lstat(path: any, options: any, callback: any, ...args: any[]): void;
export function lstatSync(path: any, options: any): any;
export function mkdir(path: any, mode: any, callback: any, ...args: any[]): void;
export function mkdirSync(path: any, mode: any): void;
...
export function realpath(p: any, options: any, callback: any): void;
export namespace realpath {
    function native(path: any, options: any, callback: any): any;
}
export function realpathSync(p: any, options: any): any;
export namespace realpathSync {
    function native(path: any, options: any): any;
}
...
export function stat(path: any, options: any, callback: any, ...args: any[]): void;
