...
export function appendFile(path: any, data: any, options: any, callback: any, ...args: any[]): void;
...
export function readFile(path: any, options: any, callback: any, ...args: any[]): void;
...
export function writeFile(path: any, data: any, options: any, callback: any, ...args: any[]): void;
